...
import ships.MySteps;
import ships.ParametrSteps;

public class ShipRunnerTest extends JUnitStories {
	...
	public InjectableStepsFactory stepsFactory(){
		return new InstanceStepsFactory(configuration(), new MySteps(), new ParametrSteps() );
	}
